create table clientes (
 ...
 insert into clientes (nombre,domicilio,ciudad,codigoProvincia,telefono)
  ...
  -- 1. Provincias que no tienen clientes
  SELECT provincias.codigo, provincias.nombre FROM provincias
  LEFT JOIN clientes
  -- En esta parte se relaciona con la clave foranea de codigoprovicia
  ON clientes.codigoprovincia = provincias.codigo
  WHERE clientes.codigoprovincia IS NULL;
  
  -- 2. Que provincias tienen clientes.
   SELECT DISTINCT provincias.codigo, provincias.nombre FROM provincias
  LEFT JOIN clientes
  ON clientes.codigoprovincia = provincias.codigo
